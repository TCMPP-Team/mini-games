...
module.exports = function (PIXI, app, obj, callBack) {
  ...
  let { goBack, title, api_name, underline, logo, logoName } = fixedTemplate(PIXI, {
    obj,
    title: 'banner 广告',
    api_name: 'createBannerAd'
  });

  const bannerAdButton = p_button(PIXI, {
  ...
  const hideButton = p_button(PIXI, {
  ...
  const destroyButton = p_button(PIXI, {
    width: 576 * PIXI.ratio,
    height: 90 * PIXI.ratio,
    border: { width: 2 * PIXI.ratio, color: 0xd1d1d1 },
    alpha: 0,
