                ...
                children: [
                    {
                        label: '生命周期',
                        name: 'lifecycle',
                        path: 'globalInfo/lifecycle/index',
                    },
                    {
                        label: '系统信息',
                        name: 'systemInfo',
                        path: 'globalInfo/systemInfo/index'
                    },
                    {
                        label: '性能',
                        name: 'performance',
                        path: 'globalInfo/performance/index'
                    }
                ]
            },
            {
            ...
            },
            {
                ...
                children: [
                    ...
                    },
                    {
                        label: '数据缓存信息',
                        name: 'storageInfo',
                        path: 'storage-fileSystem/storageInfo/index',
                    },
                ],
            },
            {
