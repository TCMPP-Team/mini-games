...
module.exports = function(PIXI, app, obj, callBack) {
    ...
    //点击弹出自定义图标toast“按钮” 开始
    let toast10Tap = p_button(PIXI, {
        width: 300 * PIXI.ratio,
        height: 120 * PIXI.ratio,
        color: 0xeeeeee,
    ...
    toast10Tap.addChild(
        p_text(PIXI, {
            ...
            lineHeight: 45 * PIXI.ratio,
            vertical_center_correction_value: 13 * PIXI.ratio,
            relative_middle: { containerWidth: toast10Tap.width, containerHeight: toast10Tap.height }
        })
    );
    toast10Tap.onClickFn(() => {
        callBack({
            status: 'toast10Tap'
        });
    });
    //点击弹出自定义图标toast“按钮” 结束
    ...
    let toast2Tap = p_button(PIXI, {
        ...
        height: 120 * PIXI.ratio,
        color: 0xeeeeee,
        y: toast10Tap.y + toast10Tap.height + 20 * PIXI.ratio
    });
    toast2Tap.addChild(
        p_text(PIXI, {
            content: '点击弹出设置\nduration的toast',
    ...
    container.addChild(goBack, title, api_name, underline, toast1Tap, toast10Tap, toast2Tap, toast3Tap, hideToast, logo, logoName);
